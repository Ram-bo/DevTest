...
namespace DeveloperTest.Migrations
{
    ...
    [Migration("20200810104909_CreateCustomerTable")]
            ...
            modelBuilder.Entity("DeveloperTest.Database.Models.Job", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            When = new DateTime(2020, 8, 13, 11, 49, 9, 79, DateTimeKind.Local).AddTicks(3293)
                        });
                });

            modelBuilder.Entity("DeveloperTest.Database.Models.Job", b =>
                {
                    b.HasOne("DeveloperTest.Database.Models.Customer", null)
                        .WithMany("Jobs")
