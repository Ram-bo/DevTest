...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppCustomerDetailCustomerDetailComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<p>Customer Id: {{customer.customerId}}</p>\n<p>Name: {{customer.name}}</p>\n<p>Type: {{customer.type}}</p>\n\n<a [routerLink]=\"['/customers']\">Back</a>\n";
    /***/
  },
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      ...
      imports: [_angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClientModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_5__["AppRoutingModule"]],
      providers: [],
  ...
  function srcAppCustomerCustomerComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(CustomerComponent, [{
        ...
        key: "createCustomer",
        value: function createCustomer(form) {
          var _this2 = this;
          ...
          if (form.invalid) {
            ...
            this.customerService.CreateCustomer(this.newCustomer).then(function () {
              _this2.customerService.GetCustomers().subscribe(function (customers) {
                return _this2.customers = Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(customers);
              });
            });
          }
        }
  ...
  function srcAppJobJobComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function JobComponent(engineerService, customerService, jobService) {
        ...
        value: function createJob(form) {
          ...
          if (form.invalid) {
            ...
            this.jobService.CreateJob(this.newJob).then(function () {
              _this5.jobService.GetJobs().subscribe(function (jobs) {
    ...
    function () {
      ...
      _createClass(CustomerService, [{
        ...
        value: function GetCustomer(customerId) {
          return this.httpClient.get("http://localhost:63235/customer/".concat(customerId)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["shareReplay"])());
        }
      }, {
        key: "CreateCustomer",
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\aksha\source\repos\DevTest\ui\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
